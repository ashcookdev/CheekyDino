...
export default function AdminUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = adminRecord
      ...
      : initialValues;
    setMonday(
      typeof cleanValues.Monday === "string" || cleanValues.Monday === null
        ? cleanValues.Monday
        : JSON.stringify(cleanValues.Monday)
    );
    setTuesday(
      typeof cleanValues.Tuesday === "string" || cleanValues.Tuesday === null
        ? cleanValues.Tuesday
        : JSON.stringify(cleanValues.Tuesday)
    );
    setWednesday(
      typeof cleanValues.Wednesday === "string" ||
        cleanValues.Wednesday === null
        ? cleanValues.Wednesday
        : JSON.stringify(cleanValues.Wednesday)
    );
    setThursday(
      typeof cleanValues.Thursday === "string" || cleanValues.Thursday === null
        ? cleanValues.Thursday
        : JSON.stringify(cleanValues.Thursday)
    );
    setFriday(
      typeof cleanValues.Friday === "string" || cleanValues.Friday === null
        ? cleanValues.Friday
        : JSON.stringify(cleanValues.Friday)
    );
    setSaturday(
      typeof cleanValues.Saturday === "string" || cleanValues.Saturday === null
        ? cleanValues.Saturday
        : JSON.stringify(cleanValues.Saturday)
    );
    setSunday(
      typeof cleanValues.Sunday === "string" || cleanValues.Sunday === null
        ? cleanValues.Sunday
        : JSON.stringify(cleanValues.Sunday)
    );
    setTableData(
      typeof cleanValues.TableData === "string" ||
        cleanValues.TableData === null
        ? cleanValues.TableData
        : JSON.stringify(cleanValues.TableData)
    );
    setSessionPriceList(
      typeof cleanValues.SessionPriceList === "string" ||
        cleanValues.SessionPriceList === null
        ? cleanValues.SessionPriceList
        : JSON.stringify(cleanValues.SessionPriceList)
    );
    setAdultPrice(cleanValues.AdultPrice);
    setCalculationCode(
      typeof cleanValues.CalculationCode === "string" ||
        cleanValues.CalculationCode === null
        ? cleanValues.CalculationCode
        : JSON.stringify(cleanValues.CalculationCode)
    );
    setPartyPriceList(
      typeof cleanValues.PartyPriceList === "string" ||
        cleanValues.PartyPriceList === null
        ? cleanValues.PartyPriceList
        : JSON.stringify(cleanValues.PartyPriceList)
    );
    setUpdateURL(cleanValues.UpdateURL);
    setClosedDates(cleanValues.ClosedDates ?? []);
    setCurrentClosedDatesValue("");
    setPartyTimeslots(
      typeof cleanValues.PartyTimeslots === "string" ||
        cleanValues.PartyTimeslots === null
        ? cleanValues.PartyTimeslots
        : JSON.stringify(cleanValues.PartyTimeslots)
    );
    setDefaultSlots(
      typeof cleanValues.DefaultSlots === "string" ||
        cleanValues.DefaultSlots === null
        ? cleanValues.DefaultSlots
        : JSON.stringify(cleanValues.DefaultSlots)
    );
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Admin, idProp)
        : adminModelProp;
