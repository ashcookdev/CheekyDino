...
export default function HotDrinksCreateForm(props) {
  ...
  const resetStateValues = () => {
    setTea(initialValues.Tea);
    setSpecialTea(initialValues.SpecialTea);
    setHotChocolate(initialValues.HotChocolate);
    setCappaccino(initialValues.Cappaccino);
    setDecaff(initialValues.Decaff);
    setHotChocolateCreamMarshmellow(initialValues.HotChocolateCreamMarshmellow);
    setLatte(initialValues.Latte);
    setMocha(initialValues.Mocha);
    setAmericanoWhite(initialValues.AmericanoWhite);
    setAmericanoBlack(initialValues.AmericanoBlack);
    setExpresso(initialValues.Expresso);
    setDoubleExpresso(initialValues.DoubleExpresso);
    setFlatWhite(initialValues.FlatWhite);
