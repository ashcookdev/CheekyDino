...
import { CustomeEvent } from "../models";
...
export declare type CustomeEventUpdateFormInputValues = {
    EventName?: string;
    EventDate?: string;
    EventTime?: string;
    CustomerName?: string;
...
export declare type CustomeEventUpdateFormValidationValues = {
...
export declare type CustomeEventUpdateFormOverridesProps = {
    CustomeEventUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CustomeEventUpdateFormProps = React.PropsWithChildren<{
    overrides?: CustomeEventUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    customeEvent?: CustomeEvent;
    onSubmit?: (fields: CustomeEventUpdateFormInputValues) => CustomeEventUpdateFormInputValues;
    onSuccess?: (fields: CustomeEventUpdateFormInputValues) => void;
    onError?: (fields: CustomeEventUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CustomeEventUpdateFormInputValues) => CustomeEventUpdateFormInputValues;
    onValidate?: CustomeEventUpdateFormValidationValues;
} & React.CSSProperties>;
export default function CustomeEventUpdateForm(props: CustomeEventUpdateFormProps): React.ReactElement;
