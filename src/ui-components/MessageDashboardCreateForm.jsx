...
export default function MessageDashboardCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MessageDashboard(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MessageDashboardCreateForm")}
      {...rest}
    >
      <TextField
        label="Content"
