...
export default function SoftDrinksUpdateForm(props) {
  const {
    id: idProp,
    softDrinks: softDrinksModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = softDrinksRecord
      ? { ...initialValues, ...softDrinksRecord }
      : initialValues;
    setFantaLemonBottle(cleanValues.FantaLemonBottle);
    setFantaTwistBottle(cleanValues.FantaTwistBottle);
    setFantaOrangeBottle(cleanValues.FantaOrangeBottle);
    setFantaOrangeZeroBottle(cleanValues.FantaOrangeZeroBottle);
    setCokeBottle(cleanValues.CokeBottle);
    setDietCokeBottle(cleanValues.DietCokeBottle);
    setCokeZeroBottle(cleanValues.CokeZeroBottle);
    setSprite(cleanValues.Sprite);
    setAppleJuiceCarton(cleanValues.AppleJuiceCarton);
    setOrangeJuiceCarton(cleanValues.OrangeJuiceCarton);
    setJugOfSquash(cleanValues.JugOfSquash);
    setSlushy(cleanValues.Slushy);
    setFruitShoot(cleanValues.FruitShoot);
    setWater(cleanValues.Water);
    setNinjuApple(cleanValues.NinjuApple);
    setNinjuTropical(cleanValues.NinjuTropical);
    setErrors({});
  };
  const [softDrinksRecord, setSoftDrinksRecord] =
    React.useState(softDrinksModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(SoftDrinks, idProp)
        : softDrinksModelProp;
      setSoftDrinksRecord(record);
    };
    queryData();
  }, [idProp, softDrinksModelProp]);
  React.useEffect(resetStateValues, [softDrinksRecord]);
  const validations = {
    FantaLemonBottle: [],
    FantaTwistBottle: [],
    FantaOrangeBottle: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            SoftDrinks.copyOf(softDrinksRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SoftDrinksUpdateForm")}
      {...rest}
    >
      <TextField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || softDrinksModelProp)}
