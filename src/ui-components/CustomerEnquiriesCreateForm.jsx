...
export default function CustomerEnquiriesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setToMarketing(initialValues.ToMarketing);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerEnquiries(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerEnquiriesCreateForm")}
      {...rest}
    >
      <TextField
        label="To"
