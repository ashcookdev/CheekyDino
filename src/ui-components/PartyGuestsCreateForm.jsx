...
export default function PartyGuestsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFoodOption(initialValues.FoodOption);
    setAllergies(initialValues.Allergies);
    setContactInfoEmail(initialValues.ContactInfoEmail);
    setArrived(initialValues.Arrived);
    setSweetConeColour(initialValues.SweetConeColour);
    setTeddyTasticBear(initialValues.TeddyTasticBear);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PartyGuests(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PartyGuestsCreateForm")}
      {...rest}
    >
      <TextField
        label="Child name"
