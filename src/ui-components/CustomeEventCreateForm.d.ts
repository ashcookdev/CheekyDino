...
export declare type CustomeEventCreateFormInputValues = {
    EventName?: string;
    EventDate?: string;
    EventTime?: string;
    CustomerName?: string;
...
export declare type CustomeEventCreateFormValidationValues = {
...
export declare type CustomeEventCreateFormOverridesProps = {
    CustomeEventCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CustomeEventCreateFormProps = React.PropsWithChildren<{
    overrides?: CustomeEventCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CustomeEventCreateFormInputValues) => CustomeEventCreateFormInputValues;
    onSuccess?: (fields: CustomeEventCreateFormInputValues) => void;
    onError?: (fields: CustomeEventCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CustomeEventCreateFormInputValues) => CustomeEventCreateFormInputValues;
    onValidate?: CustomeEventCreateFormValidationValues;
} & React.CSSProperties>;
export default function CustomeEventCreateForm(props: CustomeEventCreateFormProps): React.ReactElement;
