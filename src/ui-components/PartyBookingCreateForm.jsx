...
export default function PartyBookingCreateForm(props) {
  ...
  const resetStateValues = () => {
    setPartyType(initialValues.PartyType);
    setChildName(initialValues.ChildName);
    setChildAge(initialValues.ChildAge);
    setPartyDate(initialValues.PartyDate);
    setPartyTime(initialValues.PartyTime);
    setNoOfChildren(initialValues.NoOfChildren);
    setThirdPartyContactedDate(initialValues.ThirdPartyContactedDate);
    setFoodOptionSelected(initialValues.FoodOptionSelected);
    setTotal(initialValues.Total);
    setSweetConesSelected(initialValues.SweetConesSelected);
    setCharacterSelected(initialValues.CharacterSelected);
    setBearVoiceRecorders(initialValues.BearVoiceRecorders);
    setPartyFoodPrepared(initialValues.PartyFoodPrepared);
    setPartyHostAssigned(initialValues.PartyHostAssigned);
    setPartyChildMumArrived(initialValues.PartyChildMumArrived);
    setPartyFoodTimeDue(initialValues.PartyFoodTimeDue);
    setPartyFinish(initialValues.PartyFinish);
