...
export default function BreakfastCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setWhiteBread(initialValues.WhiteBread);
    setBrownBread(initialValues.BrownBread);
    setEgg(initialValues.Egg);
    setFried(initialValues.Fried);
    setScrambled(initialValues.Scrambled);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Breakfast(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BreakfastCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
