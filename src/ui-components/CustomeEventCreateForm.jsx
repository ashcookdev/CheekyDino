...
export default function CustomeEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFoodOptions(initialValues.FoodOptions);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomeEvent(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomeEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Event name"
