...
export default function SessionCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBookedArrivalTime(initialValues.BookedArrivalTime);
    setDate(initialValues.Date);
    setPaid(initialValues.Paid);
    setTable(initialValues.Table);
    setTimeLeftBranch(initialValues.TimeLeftBranch);
    setTimeArrrived(initialValues.TimeArrrived);
    setBookedExitTime(initialValues.BookedExitTime);
    setAmountSpent(initialValues.AmountSpent);
    setTableOrders(initialValues.TableOrders);
    setErrors({});
  };
  const validations = {
    Name: [],
