...
const product = {
  ...
  'Is it time to light another candle on the cake? As a parent, of course, you want the coolest birthday party for your child! We are 100% your partner in crime, ready to throw a party you have never seen before!',
    highlights: [
    '- £395 up to 30 children. Any extra children will be charged at £14.50 per child.',
    '- 5pm- 7pm on Fridays, Saturdays and Sundays.',
     '- 40 mins party food of your choice of hot or cold.',
    '- 80 mins of play.',
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <button onClick={() => {
                  setDetails([{
                    name: "Private Hire",
                    price: product.price,
                    description: "Private Hire Party Booking",
                  }]);
                  setClick("clicked");
                }}
                  type="button"
