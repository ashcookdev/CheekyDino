...
const product = {
  ...
  'Is it time to light another candle on the cake? As a parent, of course, you want the coolest birthday party for your child! We are 100% your partner in crime, ready to throw a party you have never seen before!',
    highlights: [
    '- £145 this includes up to 10 children, if you need to add more children you can add more on your party on your booking form. It is £14.50 for any extra child.',
     '- 60 minutes play in the play.',
    '- 40 minutes in the party room where food will be served.',
    '- 20 minutes food after food time.',
    '- Unlimited Squash.',
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
              ...
              <button onClick={handleEnquiry}
                type="button"
                className="flex w-full items-center component-title justify-center rounded-md border border-transparent bg-orange-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                Make An Enquiry
              </button>
