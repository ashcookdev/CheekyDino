...
import Trex from './customer-pages/party/Trex';
import Character from './customer-pages/party/Character';
      ...
      <Routes>
        {isSignedIn && !allowedGroups.includes(userGroup) && (
          <>
            ...
            <Route path="/contactus" element={<CustMessages />} />
      ...
      <Routes>
        ...
        {allowedGroups.includes(userGroup) && (
          <>
            ...
            <Route path= '/partybooking' element={<PartyStaffCalender />} />
