  ...
  useEffect(() => {
    const fetchAvailability = async () => {
      ...
      const freeTablesPerTimeslot = timeslots.map(timeslot => {
        ...
        freeTables = freeTables.filter(table => !bookingsForDate.some(booking => booking.TimeslotFrom < timeslot.end && booking.TimeslotTo > timeslot.start && booking.Table === table.table));
