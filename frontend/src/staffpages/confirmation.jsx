                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                        <p className="text-sm text-gray-500">
                            {paymentStatus === 'Payment successful' ? 'Thank you for your payment. Your order has been successfully placed.' : 'We were unable to process your payment. Please try again.'}
                        </p>
                    </div>
                  </div>
                </div>
