...
export default function DailyFinancialsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setGross(initialValues.Gross);
    setVATReturns(initialValues.VATReturns);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new DailyFinancials(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DailyFinancialsCreateForm")}
      {...rest}
    >
      <TextField
        label="Gross"
