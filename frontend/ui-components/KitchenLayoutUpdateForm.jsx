...
export default function KitchenLayoutUpdateForm(props) {
  const {
    id: idProp,
    kitchenLayout: kitchenLayoutModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = kitchenLayoutRecord
      ? { ...initialValues, ...kitchenLayoutRecord }
      : initialValues;
  ...
  const [kitchenLayoutRecord, setKitchenLayoutRecord] = React.useState(
    kitchenLayoutModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(KitchenLayout, idProp)
        : kitchenLayoutModelProp;
      setKitchenLayoutRecord(record);
    };
    queryData();
  }, [idProp, kitchenLayoutModelProp]);
  React.useEffect(resetStateValues, [kitchenLayoutRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            KitchenLayout.copyOf(kitchenLayoutRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "KitchenLayoutUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || kitchenLayoutModelProp)}
